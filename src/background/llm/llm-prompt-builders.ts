...
export function buildFinalMarkdownPrompt(options: FinalSynthesisInput) {
  ...
  return [
    ...
    "",
    "Output:",
    "Return markdown only. Do not return JSON, code fences, tool logs, or internal reasoning.",
    "",
    "Hard rules:",
    "1. Write in concise Chinese.",
    "2. Answer the user's goal directly. Start with the main conclusion.",
    "3. Use only provided evidence, unresolvedIssues, and relevant conversation context.",
    "4. Do not introduce external facts, assumptions, prices, claims, or links not present in the input.",
