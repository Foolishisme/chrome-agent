...
export function buildFinalResultPrompt(options: {
  ...
  return [
    ...
    "Return JSON only.",
    'Schema: {"summary":"...","markdown":"...","keyResults":["..."],"suggestedNextAction":"..."}',
    "One-shot examples:",
    ...
    'Output: {"summary":"已基于结构化候选整理出预算内建议。","markdown":"## 推荐结论\\n预算内已有可选项，优先看便携性和日常办公体验。\\n\\n## 推荐项\\n- [A](https://example.com/a) | 2999 | 轻薄，日常办公","keyResults":["预算内已有可选项","已保留可点击商品链接"],"suggestedNextAction":"如需更精细筛选，可补充预算、尺寸或品牌偏好。"}',
    ...
    '- "keyResults" must contain 1-4 short bullets.',
    '- "suggestedNextAction" must be one concrete next step.',
