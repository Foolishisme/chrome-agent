...
export function buildTaskRoutePromptWithContext(
  ...
  return [
    ...
    "- site_overview is for reading one official/target website only when the user gives a URL or explicitly asks to inspect a specific official site/website/站点/官网.",
    ...
    "- If the user asks about a company's products, platform, docs, features, or pricing without a URL or explicit official-site wording, choose public_research instead of site_overview.",
